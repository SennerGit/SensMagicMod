...
public class MakeAlchemyCategoryProvider
{
    public BookCategoryModel makeAlchemyCategory(BookLangHelper helper) {
        helper.category("alchemy_category"); //tell our lang helper the category we are in
        ...
        return BookCategoryModel.create(
                ...
                .withIcon(ModBlockss.WIZARD_ALCHEMY_STATION.getId().toString()); //the icon for the category. In this case we simply use an existing item.
    }
}
