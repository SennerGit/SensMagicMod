...
public class ModConfiguredFeatures
{
    ...
    public static final ResourceKey<ConfiguredFeature<?, ?>> OVERWORLD_BLOOD_STONE_KEY = registerKey("blood_stone_ore");
    ...
    public static void bootstrap(BootstapContext<ConfiguredFeature<?, ?>> context)
    {
        ...
        List<OreConfiguration.TargetBlockState> overworldOrichalcumOres = List.of(
                OreConfiguration.target(stoneReplaceables, ModBlockss.ORICHALCUM_ORE.get().defaultBlockState()),
                OreConfiguration.target(deepslateReplaceables, ModBlockss.ORICHALCUM_DEEPSLATE_ORE.get().defaultBlockState()));

        List<OreConfiguration.TargetBlockState> overworldMythrilOres = List.of(
                OreConfiguration.target(stoneReplaceables, ModBlockss.MYTHRIL_ORE.get().defaultBlockState()),
                OreConfiguration.target(deepslateReplaceables, ModBlockss.MYTHRIL_DEEPSLATE_ORE.get().defaultBlockState()));

        List<OreConfiguration.TargetBlockState> overworldBloodStoneOres = List.of(
                OreConfiguration.target(stoneReplaceables, ModBlockss.BLOOD_STONE_ORE.get().defaultBlockState()),
                OreConfiguration.target(deepslateReplaceables, ModBlockss.BLOOD_STONE_DEEPSLATE_ORE.get().defaultBlockState()));
        ...
        register(context, OVERWORLD_ORICHALCUM_KEY, Feature.ORE, new OreConfiguration(overworldOrichalcumOres, 9));
        register(context, OVERWORLD_MYTHRIL_KEY, Feature.ORE, new OreConfiguration(overworldMythrilOres, 9));
        register(context, OVERWORLD_BLOOD_STONE_KEY, Feature.ORE, new OreConfiguration(overworldBloodStoneOres, 9));
