...
{
    public static final ImmutableList<ItemLike> CRIMSON_STEEL_SMELTABLES = ImmutableList.of(ModItems.CRIMSON_STEEL_RAW.get(), ModBlockss.CRIMSON_STEEL_ORE.get(), ModBlockss.CRIMSON_STEEL_DEEPSLATE_ORE.get());
    ...
    private void createOreRecipes(String name, Consumer<FinishedRecipe> consumer, ImmutableList<ItemLike> smeltable, ItemLike ingot, ItemLike raw, ItemLike nugget, ItemLike metalBlock, ItemLike rawBlock)
    {
        ...
        NineBlockStorageRecipesRecipesWithCustomUnpacking(consumer, RecipeCategory.MISC, ingot, RecipeCategory.BUILDING_BLOCKS, metalBlock, name+"_ingot_from_"+name+"_block", name+"_ingot");
